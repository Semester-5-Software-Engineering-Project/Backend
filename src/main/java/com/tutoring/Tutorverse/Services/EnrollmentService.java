...
public class EnrollmentService {
    ...
    public UUID getEnrollmentId(UUID userId, UUID fromString) {
        Optional<EnrollmentEntity> enrollment = enrollRepository.findByStudentStudentIdAndModuleModuleId(userId, fromString);
        return enrollment.map(EnrollmentEntity::getEnrolmentId).orElse(null);
    }
